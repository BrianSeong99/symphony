...
polling:
  interval_ms: 10000
workspace:
  root: ~/Develop/Labs/worktrees/symphony-cfo-github-test
  source_repo: ~/Develop/Labs/Finance-OS/cfo
...
You are working on a GitHub issue in Brian's CFO / Finance-OS repository.
...
blocks. Optional connectors and MCP tools are not required for CFO GitHub issue
work.
