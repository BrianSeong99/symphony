...
tracker:
  kind: github
  repository: Whitepaper-Reading-Club/wprc-website
  active_labels:
    - agent:symphony
  terminal_states:
    - Closed
...
polling:
  interval_ms: 10000
workspace:
  root: ~/Develop/Labs/worktrees/symphony-wprc-website-github-test
  source_repo: ~/Develop/WPRC/wprc-website
...
hooks:
  after_create: |
    if git remote get-url origin >/dev/null 2>&1; then
      git remote set-url origin git@github.com:Whitepaper-Reading-Club/wprc-website.git
    else
      git remote add origin git@github.com:Whitepaper-Reading-Club/wprc-website.git
    fi
...
You are working on a GitHub issue in the WPRC website repository.
