defmodule SymphonyElixir.RunnerObserver do
  ...
  @classification_patterns [
    ...
    {:startup_no_progress, ["startup_no_progress", "startup no progress", "first progress", "no startup progress"]},
  ...
  def suggested_action(:startup_no_progress),
    do: "Stop the process, preserve the worktree, and require a compact orientation summary, file shortlist, command milestone, edit, validation action, or blocker before retry."
